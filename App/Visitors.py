...
# === Background Image ===
background_image = Image.open("bg.jpg")  # Put your background.png in the same folder or give complete path 
...
logo_image = Image.open("logo.png")  # Replace with your actual logo file name
